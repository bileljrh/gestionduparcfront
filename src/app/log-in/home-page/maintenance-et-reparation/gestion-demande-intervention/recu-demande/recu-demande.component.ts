...
@Component({
  selector: 'app-recu-demande',
  templateUrl: './recu-demande.component.html',
  styleUrls: ['./recu-demande.component.scss'],
  providers: [MatSnackBar]

})
export class RecuDemandeComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<RecuDemandeComponent>,
