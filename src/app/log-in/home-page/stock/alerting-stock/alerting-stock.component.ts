...
@Component({
  selector: 'app-alerting-stock',
  templateUrl: './alerting-stock.component.html',
  styleUrls: ['./alerting-stock.component.scss'],
  providers: [MatSnackBar]

})
export class AlertingStockComponent implements OnInit {
  ...
  alertArticleList: Article[] = [];
  dataSource = new MatTableDataSource<Article>(this.alertArticleList);
  ...
  getTotalItems() {
    ...
    this.stockServiceService.findArticleForAlerting(this.paginConfig.currentPage.toString(), this.paginConfig.itemsPerPage.toString()).subscribe(value => {
      console.log(value);
      this.alertArticleList = value;
      this.dataSource = new MatTableDataSource<Article>(this.alertArticleList);
