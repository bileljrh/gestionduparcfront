...
@Component({
  selector: 'app-artices-for-transfert-to-virtual-magasin',
  templateUrl: './artices-for-transfert-to-virtual-magasin.component.html',
  styleUrls: ['./artices-for-transfert-to-virtual-magasin.component.scss']
})
export class ArticesForTransfertToVirtualMagasinComponent implements OnInit {
  ...
  nouvelArticleForm = new FormGroup({
    'codeArticleForm': new FormControl(null, Validators.required),
    'designationForm': new FormControl(null, Validators.required),
    'quantiteDispoForm': new FormControl(),
    'qteTransfererForm': new FormControl(0)
  });
  ...
  nouveauDemandeArticle: MagasinRotationNull = {
  ...
  constructor(public dialogRef: MatDialogRef<ArticesForTransfertToVirtualMagasinComponent>, 
  ...
  onConfirm() {
    if (this.nouvelArticleForm.valid) {
      this.nouveauDemandeArticle = {
        confirmed:  false,
        validated: false,
        designation: this.nouvelArticleForm.value.designationForm,
        codeArticle:  this.nouvelArticleForm.value.codeArticleForm,
        quantiteStock:  this.nouvelArticleForm.value.quantiteStockForm,
        prix:  this.nouvelArticleForm.value.prixForm
      };
